...
public class TokenManager {
    ...
    public int banToken(String token) {
        Iterator<TokenInfo> iterator = tokenList.iterator();
        ...
        // Assuming each pixel set by this token is considered a record in the database
        // For simplicity, returning number of tokens removed (which is always 1 in this simple implementation)
